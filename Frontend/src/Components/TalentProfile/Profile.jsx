    ...
    return <div className="w-2/3 lg-mx:w-full">
        <div className="" >
            <div className="relative">
                ...
                <img className="rounded-t-2xl xl-mx:h-40 w-full xs-mx:h-32 " src="/Profile/Default_Banner.jpg" alt="" />
            ...
            <div className="px-3 mt-16">
                ...
                <div className="text-lg flex xs-mx:text-base gap-1 items-center text-[#ced4da]">
                    <IconMapPin className="h-5 w-5" stroke={1.5} /> {profile?.location}
                </div>
                <div className="text-lg xs-mx:text-base flex gap-1 items-center text-[#ced4da]">
                    <IconBriefcase className="h-5 w-5" stroke={1.5} /> Experience: {profile?.totalExp} Years
                </div>
                <Divider my="xl" />
                <div>
                    <div className="text-2xl font-semibold mb-3">About</div>
                    <div className="text-sm text-[#ced4da] text-justify">{profile?.about}</div>
                </div>
                <Divider my="xl" />
                <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                        {
                            profile?.skills?.map((skill, index) => <div key={index} className="bg-bright-sun-300 rounded-3xl px-3 py-1 text-sm font-medium bg-opacity-15 text-[#4682B4]">{skill}</div>)
                        }

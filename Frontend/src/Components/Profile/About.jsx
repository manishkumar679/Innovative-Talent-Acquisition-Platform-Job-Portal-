...
const About = () => {
    ...
    return <div data-aos="fade-up">
        ...
        {edit ? <Textarea data-aos="zoom-out" value={about} onChange={(e) => setAbout(e.target.value)} autosize minRows={2} placeholder="Enter about yourself" /> : <div className="text-sm text-[#ced4da] text-justify">{profile.about}</div>
        }
    </div>
}

...
const SearchBar = () => {
    ...
    return (<div>
        ...
        <div className="px-5 py-8 lg-mx:!flex-wrap items-center text-[#e9ecef]! flex ">
            <div className="w-1/5 lg-mx:w-1/4 bs-mx:w-[30%] sm-mx:w-[48%] xs-mx:w-full xs-mx:mb-1 flex items-center ">
                <div className="bg-[#1a1a1a] rounded-full mr-2 text-[#4682B4] p-1"><IconUserCircle size={20} /> </div>
                <Input defaultValue={name} onChange={(e)=>handleChange("name",e)} className="[&_input]:placeholder-[#ced4da]!" variant="unstyled" placeholder="Talent Name" />
            </div>
            ...
            <div className="w-1/5 lg-mx:w-1/4 lg-mx:mt-7 bs-mx:w-[30%]  sm-mx:w-[48%] xs-mx:w-full text-sm text-[#ced4da] [&_.mantine-Slider-label]:translate-y-10! xs-mx:mb-1 ">

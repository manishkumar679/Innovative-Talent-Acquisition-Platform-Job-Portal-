...
<Login/>
        <div className={`w-1/2 h-[100vh] sm-mx:hidden  sm-mx:min-h-full transition-all duration-1000 flex  items-center  gap-5 justify-center flex-col ${location.pathname=='/signup'?'rounded-r-[200px]':'rounded-l-[200px]'} bg-[#1a1a1a]`}>
            <div className="flex gap-1 items-center text-[#4682B4]">
                <IconAnchor className="h-16 w-16" stroke={2.5} />
                <div className="text-6xl bs-mx:text-5xl md-mx:text-4xl sm-mx:text-3xl font-semibold">JobNest</div>
            </div>
            <div className="text-2xl bs-mx:text-xl md-mx:text-lg text-[#dee2e6] font-semibold">Find the job made for you</div>
        </div>
        <SignUp  />
        </div>
    </div>
